...
var socket =io.connect('ws://b91dc8e8.ngrok.io', { "forceBase64" : 1 });
...
// 	fetch('http://58df6b50.ngrok.io/sensor',{method: 'GET', headers: { "Content-type": "application/x-www-form-urlencoded; charset=UTF-8"}}).then(function(res){
// 		status=res.status;
// 		response_ok = res.ok;
// 	    return res.json();
...
// 		// console.log(res);
// 		received.value = "Temperature = " + JSON.stringify(res[res.length -1].Temperature) + "   " + "Humidity = " + JSON.stringify(res[res.length -1].Humidity);
