// This file was generated based on /usr/local/share/uno/Packages/Fuse.Maps/1.9.0/MapView.uno.
...
struct IMapView
{
    ...
    void(*fp_HandleMarkerTapped)(uObject*, int32_t*, uString*);
    ...
    void(*fp_get_Style)(uObject*, int32_t*);
    ...
    static void HandleMarkerTapped(const uInterface& __this, int32_t id, uString* label) { __this.VTable<IMapView>()->fp_HandleMarkerTapped(__this, &id, label); }
    ...
    static int32_t Style(const uInterface& __this) { int32_t __retval; return __this.VTable<IMapView>()->fp_get_Style(__this, &__retval), __retval; }
    static void Style(const uInterface& __this, int32_t value) { __this.VTable<IMapView>()->fp_set_Style(__this, &value); }
