...
{
    uStackFrame __("Uno.IO.AAssetManager", "GetPtr()");
    AAssetManager_typeof()->Init();
...
{
    uStackFrame __("Uno.IO.AAssetManager", "OpenOrThrow(string)");
    AAssetManager_typeof()->Init();
...
::g::Uno::IO::Stream_type* AAssetStream_typeof()
{
    ...
    type->fp_get_CanRead = (void(*)(::g::Uno::IO::Stream*, bool*))AAssetStream__get_CanRead_fn;
    type->fp_get_CanSeek = (void(*)(::g::Uno::IO::Stream*, bool*))AAssetStream__get_CanSeek_fn;
    type->fp_get_CanWrite = (void(*)(::g::Uno::IO::Stream*, bool*))AAssetStream__get_CanWrite_fn;
    ...
    type->fp_get_Position = (void(*)(::g::Uno::IO::Stream*, int64_t*))AAssetStream__get_Position_fn;
    type->fp_set_Position = (void(*)(::g::Uno::IO::Stream*, int64_t*))AAssetStream__set_Position_fn;
    type->fp_Read = (void(*)(::g::Uno::IO::Stream*, uArray*, int32_t*, int32_t*, int32_t*))AAssetStream__Read_fn;
    type->fp_Seek = (void(*)(::g::Uno::IO::Stream*, int64_t*, int32_t*, int64_t*))AAssetStream__Seek_fn;
    type->fp_SetLength = (void(*)(::g::Uno::IO::Stream*, int64_t*))AAssetStream__SetLength_fn;
...
// public override sealed long get_Position() :377
void AAssetStream__get_Position_fn(AAssetStream* __this, int64_t* __retval)
{
    __this->CheckDisposed();
    return *__retval = AAsset_getLength(__this->_fp) - AAsset_getRemainingLength(__this->_fp), void();
}

// public override sealed void set_Position(long value) :382
void AAssetStream__set_Position_fn(AAssetStream* __this, int64_t* value)
{
    int64_t value_ = *value;
    __this->CheckDisposed();
    AAsset_seek(__this->_fp, value_, SEEK_SET);
}
...
{
    uStackFrame __("Uno.IO.AAssetStream", "Read(byte[],int,int)");
...
// public override sealed long Seek(long byteOffset, Uno.IO.SeekOrigin origin) :408
void AAssetStream__Seek_fn(AAssetStream* __this, int64_t* byteOffset, int32_t* origin, int64_t* __retval)
{
    ...
    {
    case 0:
        AAsset_seek(__this->_fp, byteOffset_, SEEK_SET);
        break;
    case 1:
        AAsset_seek(__this->_fp, byteOffset_, SEEK_CUR);
        break;
    case 2:
        AAsset_seek(__this->_fp, byteOffset_, SEEK_END);
        break;
    }
...
// public override sealed void SetLength(long value) :389
void AAssetStream__SetLength_fn(AAssetStream* __this, int64_t* value)
{
    uStackFrame __("Uno.IO.AAssetStream", "SetLength(long)");
...
{
    uStackFrame __("Uno.IO.AAssetStream", "Write(byte[],int,int)");
    U_THROW(::g::Uno::NotImplementedException::New4());
}
...
{
    uStackFrame __("Uno.IO.AAssetStream", ".ctor(string)");
    ctor_();
...
{
    uStackFrame __("Uno.IO.AAssetStream", "CheckDisposed()");
...
static void BinaryReader_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("Invalid 7 bit encoded int");
    ::TYPES[1] = ::g::Uno::Byte_typeof()->Array();
    ::TYPES[2] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Byte_typeof(), NULL);
    type->SetInterfaces(
    ...
    type->Reflection.SetFunctions(11,
        ...
        new uFunction("ReadBytes", NULL, (void*)BinaryReader__ReadBytes_fn, 0, false, ::TYPES[1/*byte[]*/], 1, ::g::Uno::Int_typeof()),
...
int32_t BinaryReader::Read7BitEncodedInt()
{
    ...
    U_THROW(::g::Uno::FormatException::New4(::STRINGS[4/*"Invalid 7 b...*/]));
}
...
static void BinaryWriter_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[1/*byte[]*/], offsetof(BinaryWriter, _buffer), 0,
    ...
    type->Reflection.SetFunctions(11,
        ...
        new uFunction("Write", NULL, (void*)BinaryWriter__Write2_fn, 0, false, uVoid_typeof(), 1, ::TYPES[1/*byte[]*/]),
        new uFunction("Write", NULL, (void*)BinaryWriter__Write5_fn, 0, false, uVoid_typeof(), 1, ::TYPES[3/*char*/]),
...
void BinaryWriter::Write5(char16_t value)
{
    ...
    Write2(::g::Uno::Text::Utf8::GetBytes(::g::Uno::Char::ToString(value, ::TYPES[3/*char*/])));
}
...
static void Bundle__cctor__fn(uType* __type)
{
    ...
    int32_t index2;
    int32_t length3;
    Bundle::_bundles_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[4/*Uno.Collections.Dictionary<string, Uno.IO.Bundle>*/]));
    Bundle::_allFiles_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[5/*Uno.Collections.List<Uno.IO.BundleFile>*/]));

    for (array1 = ::g::Uno::String::Split(uPtr(::g::Uno::IO::BundleFile::New1(Bundle::New1(NULL), ::STRINGS[5/*"bundle"*/], ::STRINGS[5/*"bundle"*/])->ReadAllText()), uArray::Init<int32_t>(::TYPES[6/*char[]*/], 1, 10)), index2 = 0, length3 = uPtr(array1)->Length(); index2 < length3; ++index2)
    {
        uString* line = uPtr(array1)->Strong<uString*>(index2);
        uArray* parts = ::g::Uno::String::Split(uPtr(line), uArray::Init<int32_t>(::TYPES[6/*char[]*/], 1, ':'));
...
{
    ::STRINGS[5] = uString::Const("bundle");
    ::STRINGS[6] = uString::Const("BundleFile not found: ");
    ::TYPES[4] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), type, NULL);
    ::TYPES[5] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof(), NULL);
    ::TYPES[6] = ::g::Uno::Char_typeof()->Array();
    ::TYPES[7] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof(), NULL);
    ::TYPES[8] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof(), NULL);
    type->SetFields(0,
        ::g::Uno::String_typeof(), offsetof(Bundle, _packageName), 0,
        ::TYPES[5/*Uno.Collections.List<Uno.IO.BundleFile>*/], offsetof(Bundle, _files), 0,
        ::TYPES[8/*Uno.Action<Uno.IO.BundleFile>*/], offsetof(Bundle, Created1), 0,
        ::TYPES[4/*Uno.Collections.Dictionary<string, Uno.IO.Bundle>*/], (uintptr_t)&Bundle::_bundles_, uFieldFlagsStatic,
        ::TYPES[5/*Uno.Collections.List<Uno.IO.BundleFile>*/], (uintptr_t)&Bundle::_allFiles_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(7,
        ...
        new uFunction("add_Created", NULL, (void*)Bundle__add_Created_fn, 0, false, uVoid_typeof(), 1, ::TYPES[8/*Uno.Action<Uno.IO.BundleFile>*/]),
        new uFunction("remove_Created", NULL, (void*)Bundle__remove_Created_fn, 0, false, uVoid_typeof(), 1, ::TYPES[8/*Uno.Action<Uno.IO.BundleFile>*/]),
...
{
    _files = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[5/*Uno.Collections.List<Uno.IO.BundleFile>*/]));
...
void Bundle::add_Created(uDelegate* value)
{
    ...
    Created1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Created1, value), ::TYPES[8/*Uno.Action<Uno.IO.BundleFile>*/]);
}
...
void Bundle::remove_Created(uDelegate* value)
{
    ...
    Created1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Created1, value), ::TYPES[8/*Uno.Action<Uno.IO.BundleFile>*/]);
}
...
::g::Uno::IO::BundleFile* Bundle::GetFile(uString* filename)
{
...

    {
        ...
        {
            {
                while (enum4.MoveNext(::TYPES[7/*Uno.Collections.List<Uno.IO.BundleFile>.Enumerator*/]))
                {
                    ::g::Uno::IO::BundleFile* f = enum4.Current(::TYPES[7/*Uno.Collections.List<Uno.IO.BundleFile>.Enumerator*/]);
                    ...
                    if (::g::Uno::String::op_Equality(uPtr(f)->SourcePath(), filename) || ::g::Uno::String::op_Equality(uPtr(f)->BundlePath(), filename))
                    {
                        ...
                        enum4.Dispose(::TYPES[7/*Uno.Collections.List<Uno.IO.BundleFile>.Enumerator*/]);
                        return __uno_retval;
                    }
                }
            }
    ...
    U_THROW(::g::Uno::IO::FileNotFoundException::New5(::g::Uno::String::op_Addition2(::STRINGS[6/*"BundleFile ...*/], filename), filename));
}
...
{
    ::STRINGS[7] = uString::Const("Uno.IO.BundleFile.BundlePath");
    ::STRINGS[8] = uString::Const("bytes");
    ::TYPES[1] = ::g::Uno::Byte_typeof()->Array();
    ::TYPES[9] = ::g::Uno::IDisposable_typeof();
    ::TYPES[8] = ::g::Uno::Action1_typeof()->MakeType(type, NULL);
    type->SetFields(0,
        ::TYPES[1/*byte[]*/], offsetof(BundleFile, _bytes), 0,
        ...
        ::TYPES[8/*Uno.Action<Uno.IO.BundleFile>*/], offsetof(BundleFile, Changed1), 0);
    type->Reflection.SetFunctions(10,
        ...
        new uFunction("add_Changed", NULL, (void*)BundleFile__add_Changed_fn, 0, false, uVoid_typeof(), 1, ::TYPES[8/*Uno.Action<Uno.IO.BundleFile>*/]),
        new uFunction("remove_Changed", NULL, (void*)BundleFile__remove_Changed_fn, 0, false, uVoid_typeof(), 1, ::TYPES[8/*Uno.Action<Uno.IO.BundleFile>*/]),
        ...
        new uFunction("ReadAllBytes", NULL, (void*)BundleFile__ReadAllBytes_fn, 0, false, ::TYPES[1/*byte[]*/], 0),
        ...
        new uFunction("Update", NULL, (void*)BundleFile__Update_fn, 0, false, uVoid_typeof(), 1, ::TYPES[1/*byte[]*/]));
}
...
void BundleFile::add_Changed(uDelegate* value)
{
    ...
    Changed1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Changed1, value), ::TYPES[8/*Uno.Action<Uno.IO.BundleFile>*/]);
}
...
void BundleFile::remove_Changed(uDelegate* value)
{
    ...
    Changed1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Changed1, value), ::TYPES[8/*Uno.Action<Uno.IO.BundleFile>*/]);
}
...
::g::Uno::IO::Stream* BundleFile::OpenRead()
{
    ...
    if (::g::Uno::String::op_Equality(BundlePath(), NULL))
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[7/*"Uno.IO.Bund...*/]));
        ...
        {
            {
                ...
                ::g::Uno::IDisposable::Dispose(uInterface(uPtr((uObject*)stream), ::TYPES[9/*Uno.IDisposable*/]));
                return __uno_retval;
            }
        }
...
void BundleFile::Update(uArray* bytes)
{
    ...
    if (bytes == NULL)
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[8/*"bytes"*/]));
...
void Directory::CreateDirectory(uString* dirName)
{
    ...
    if (::g::Uno::String::op_Equality(dirName, NULL))
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[10/*"dirName"*/]));
    ...
    if (mkdir(uCString(dirName).Ptr, S_IRWXU | S_IRWXG | S_IROTH | S_IXOTH) == 0 ||
            errno == EEXIST)
        return;
    U_THROW(::g::Uno::IO::IOException::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(uString::Const("Unable to create directory '"), dirName), ::STRINGS[17/*"'"*/])));
}
...
void Directory::Delete(uString* dirName, bool recursive)
{
    ...
    if (recursive)
    {
...

        {
            ...
            {
                {
                    ::g::Uno::IDisposable::Dispose(uInterface(uPtr(enum1), ::TYPES[9/*Uno.IDisposable*/]));
                }
                                throw __t;
...

        {
            ...
            {
                {
                    ::g::Uno::IDisposable::Dispose(uInterface(uPtr(enum2), ::TYPES[9/*Uno.IDisposable*/]));
                }
                                throw __t;
    ...
    if (rmdir(cstr.Ptr) != 0)
        U_THROW(::g::Uno::IO::IOException::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(uString::Const("Unable to delete directory '"), dirName), ::STRINGS[17/*"'"*/])));
}
...
void Directory::Move(uString* oldName, uString* newName)
{
    ...
    if (::g::Uno::String::op_Equality(oldName, NULL))
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[21/*"oldName"*/]));

    if (::g::Uno::String::op_Equality(newName, NULL))
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[22/*"newName"*/]));

    uCString oldNameU8(oldName);
    uCString newNameU8(newName);

    if (rename(oldNameU8.Ptr, newNameU8.Ptr) != 0)
        U_THROW(::g::Uno::IO::IOException::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(uString::Const("Unable to move directory '"), oldName), ::STRINGS[24/*"' to '"*/]), newName), ::STRINGS[17/*"'"*/])));
}
// }
...
{
    ::STRINGS[9] = uString::Const("Reached end of stream");
    type->SetFields(4);
    type->Reflection.SetFunctions(1,
...
{
    ::STRINGS[10] = uString::Const("dirName");
    ::STRINGS[11] = uString::Const("Directory not found: ");
...
void Directory__Enumerator::ctor_(uString* dirName, int32_t mode)
{
    ...
    dirName = ::g::Uno::String::TrimEnd(uPtr(dirName), uArray::Init<int32_t>(::TYPES[6/*char[]*/], 1, ::g::Uno::IO::Path::DirectorySeparatorChar()));

    if (!::g::Uno::IO::Directory::Exists(dirName))
        U_THROW(::g::Uno::IO::FileNotFoundException::New5(::g::Uno::String::op_Addition2(::STRINGS[11/*"Directory n...*/], dirName), dirName));

    _mode = mode;
    _prefix = (::g::Uno::String::op_Inequality(dirName, ::STRINGS[12/*"."*/]) ? (uString*)::g::Uno::String::op_Addition1(dirName, uBox<char16_t>(::TYPES[3/*char*/], ::g::Uno::IO::Path::DirectorySeparatorChar())) : ::STRINGS[13/*""*/]);
}
...
{
    ::STRINGS[14] = uString::Const("sourceFile");
    ::STRINGS[15] = uString::Const("destinationFile");
    ::STRINGS[16] = uString::Const("Unable to copy from file '");
    ::STRINGS[17] = uString::Const("'");
    ::STRINGS[18] = uString::Const("Unable to copy to file '");
    ::STRINGS[19] = uString::Const("filename");
    ::STRINGS[20] = uString::Const("Unable to delete file '");
    ::STRINGS[21] = uString::Const("oldName");
    ::STRINGS[22] = uString::Const("newName");
    ::STRINGS[23] = uString::Const("Unable to move file '");
    ::STRINGS[24] = uString::Const("' to '");
    ::STRINGS[25] = uString::Const("rb");
    ::TYPES[9] = ::g::Uno::IDisposable_typeof();
    ::TYPES[1] = ::g::Uno::Byte_typeof()->Array();
    type->Reflection.SetFunctions(12,
        ...
        new uFunction("ReadAllBytes", NULL, (void*)File__ReadAllBytes_fn, 0, true, ::TYPES[1/*byte[]*/], 1, ::g::Uno::String_typeof()),
        new uFunction("ReadAllText", NULL, (void*)File__ReadAllText_fn, 0, true, ::g::Uno::String_typeof(), 1, ::g::Uno::String_typeof()),
        new uFunction("WriteAllBytes", NULL, (void*)File__WriteAllBytes_fn, 0, true, uVoid_typeof(), 2, ::g::Uno::String_typeof(), ::TYPES[1/*byte[]*/]),
...
void File::Copy1(uString* sourceFile, uString* destinationFile, bool overwrite)
{
    ...
    if (::g::Uno::String::op_Equality(sourceFile, NULL))
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[14/*"sourceFile"*/]));

    if (::g::Uno::String::op_Equality(destinationFile, NULL))
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[15/*"destination...*/]));
    ...
    if (source == -1)
        U_THROW(::g::Uno::IO::IOException::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[16/*"Unable to c...*/], sourceFile), ::STRINGS[17/*"'"*/])));
    ...
    {
        close(source);
        U_THROW(::g::Uno::IO::IOException::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[18/*"Unable to c...*/], destinationFile), ::STRINGS[17/*"'"*/])));
    }
...
void File::Delete(uString* filename)
{
    ...
    if (::g::Uno::String::op_Equality(filename, NULL))
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[19/*"filename"*/]));

    uCString cstr(filename);

    if (unlink(cstr.Ptr) != 0)
        U_THROW(::g::Uno::IO::IOException::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[20/*"Unable to d...*/], filename), ::STRINGS[17/*"'"*/])));
}
...
void File::Move(uString* oldName, uString* newName)
{
    ...
    if (rename(oldNameU8.Ptr, newNameU8.Ptr) != 0)
        U_THROW(::g::Uno::IO::IOException::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[23/*"Unable to m...*/], oldName), ::STRINGS[24/*"' to '"*/]), newName), ::STRINGS[17/*"'"*/])));
}
...
::g::Uno::IO::FileStream* File::OpenRead(uString* filename)
{
    ...
    return ::g::Uno::IO::FileStream::New2(::g::Uno::IO::FILEPtr::OpenOrThrow(filename, ::STRINGS[25/*"rb"*/]), true, false);
}
...
{
    ::STRINGS[19] = uString::Const("filename");
    ::STRINGS[26] = uString::Const("Can't open file: ");
}
...
void FILEPtr::Throw(uString* filename)
{
    ...
    U_THROW(::g::Uno::IO::FileNotFoundException::New5(::g::Uno::String::op_Addition2(::STRINGS[26/*"Can't open ...*/], filename), filename));
}
// }
...
{
    ::STRINGS[27] = uString::Const("The file stream was closed");
    ::STRINGS[28] = uString::Const("File not found: ");
    ::STRINGS[29] = uString::Const("wb");
    ::STRINGS[30] = uString::Const("r+b");
    ::STRINGS[31] = uString::Const("File already exists: ");
    ::STRINGS[32] = uString::Const("ab");
    ::STRINGS[33] = uString::Const("mode");
    ::STRINGS[34] = uString::Const("File stream is not readable");
    ::STRINGS[35] = uString::Const("Error while seeking in file stream");
    ::STRINGS[36] = uString::Const("File stream is not writable");
    ::STRINGS[37] = uString::Const("Error while writing to file stream");
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Uno::IO::Stream_type, interface0));
    type->SetFields(0,
...
void FileStream__Read_fn(FileStream* __this, uArray* dst, int32_t* byteOffset, int32_t* byteCount, int32_t* __retval)
{
    ...
    if (__this->_canRead && __this->_canWrite)
        ...
        U_THROW(::g::Uno::IO::IOException::New4(::STRINGS[34/*"File stream...*/]));
...
void FileStream__Seek_fn(FileStream* __this, int64_t* byteOffset, int32_t* origin, int64_t* __retval)
{
    ...
    U_THROW(::g::Uno::IO::IOException::New4(::STRINGS[35/*"Error while...*/]));
}
...
void FileStream__Write_fn(FileStream* __this, uArray* src, int32_t* byteOffset, int32_t* byteCount)
{
    ...
    if (__this->_canRead && __this->_canWrite)
        ...
        U_THROW(::g::Uno::IO::IOException::New4(::STRINGS[36/*"File stream...*/]));

    int32_t result = (int)fwrite((const uint8_t*)src->Ptr() + byteOffset_, 1, byteCount_, __this->_fp);

    if (result != byteCount_)
        U_THROW(::g::Uno::IO::IOException::New4(::STRINGS[37/*"Error while...*/]));
}
...
void FileStream::CheckDisposed()
{
    ...
    if (!this->_fp)
        U_THROW(::g::Uno::ObjectDisposedException::New4(::STRINGS[27/*"The file st...*/]));
}
    ...
    switch (mode)
    {
        case 5:
        {
            if (!::g::Uno::IO::File::Exists(filename))
                U_THROW(::g::Uno::IO::FileNotFoundException::New5(::g::Uno::String::op_Addition2(::STRINGS[28/*"File not fo...*/], filename), filename));

            _canRead = true;
            _canWrite = true;
            fclose(::g::Uno::IO::FILEPtr::OpenOrThrow(filename, ::STRINGS[29/*"wb"*/]));
            return ::STRINGS[30/*"r+b"*/];
        }
        case 2:
        {
            _canRead = true;
        ...
        {
            if (::g::Uno::IO::File::Exists(filename))
                U_THROW(::g::Uno::IO::IOException::New4(::g::Uno::String::op_Addition2(::STRINGS[31/*"File alread...*/], filename)));

            _canWrite = true;
            return ::STRINGS[29/*"wb"*/];
        }
        case 4:
        {
            if (!::g::Uno::IO::File::Exists(filename))
        ...
        {
            _canWrite = true;
            return ::STRINGS[32/*"ab"*/];
        }
    }

    U_THROW(::g::Uno::ArgumentOutOfRangeException::New6(::STRINGS[33/*"mode"*/]));
}
...
{
    ::STRINGS[38] = uString::Const("originalPath");
...
void FileSystemInfo::ctor_(uString* originalPath)
{
    ...
    if (::g::Uno::String::op_Equality(originalPath, NULL))
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[38/*"originalPath"*/]));
...
{
    ::STRINGS[39] = uString::Const("buffer");
    ::TYPES[1] = ::g::Uno::Byte_typeof()->Array();
    ::TYPES[11] = ::g::Uno::Array_typeof()->MakeMethod(1/*Copy<byte>*/, ::g::Uno::Byte_typeof(), NULL);
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Uno::IO::Stream_type, interface0));
    type->SetFields(0,
    ...
    type->Reflection.SetFunctions(5,
        ...
        new uFunction("GetBuffer", NULL, (void*)MemoryStream__GetBuffer_fn, 0, false, ::TYPES[1/*byte[]*/], 0),
        new uFunction(".ctor", NULL, (void*)MemoryStream__New1_fn, 0, true, type, 0),
        new uFunction(".ctor", NULL, (void*)MemoryStream__New2_fn, 0, true, type, 1, ::TYPES[1/*byte[]*/]),
        new uFunction(".ctor", NULL, (void*)MemoryStream__New3_fn, 0, true, type, 2, ::TYPES[1/*byte[]*/], ::g::Uno::Bool_typeof()));
}
...
void MemoryStream::ctor_3(uArray* buffer, bool writable)
{
    ...
    if (buffer == NULL)
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[39/*"buffer"*/]));
...
void MemoryStream::ResizeTo(int32_t newSize)
{
    ...
    ::g::Uno::Array::Copy1(::TYPES[11/*Uno.Array.Copy<byte>*/], _buffer, newBuffer, uPtr(_buffer)->Length());
    _buffer = newBuffer;
...
{
    ::STRINGS[40] = uString::Const("path1");
    ::STRINGS[41] = uString::Const("path2");
    ::TYPES[6] = ::g::Uno::Char_typeof()->Array();
    type->SetFields(0,
        ...
        ::TYPES[6/*char[]*/], (uintptr_t)&Path::DirectorySeparatorChars_, uFieldFlagsStatic);
...
uString* Path::Combine(uString* path1, uString* path2)
{
    ...
    if (::g::Uno::String::op_Equality(path1, NULL))
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[40/*"path1"*/]));

    if (::g::Uno::String::op_Equality(path2, NULL))
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[41/*"path2"*/]));
...
uString* Path::CombineInternal(uString* a, uString* b)
{
    ...
    return ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(a, uBox<char16_t>(::TYPES[3/*char*/], Path::DirectorySeparatorChar_)), b);
}
...
{
    Path_typeof()->Init();
    return uArray::Init<int32_t>(::TYPES[6/*char[]*/], 1, '/');
}
...
{
    ::STRINGS[42] = uString::Const("StreamReader");
    ::STRINGS[39] = uString::Const("buffer");
    ::STRINGS[43] = uString::Const("index");
    ::STRINGS[44] = uString::Const("count");
    ::STRINGS[45] = uString::Const("range");
    ::TYPES[1] = ::g::Uno::Byte_typeof()->Array();
    ::TYPES[6] = ::g::Uno::Char_typeof()->Array();
    type->SetDependencies(
        ::g::Uno::Math_typeof());
    ...
    type->SetFields(0,
        ...
        ::TYPES[6/*char[]*/], offsetof(StreamReader, _charBuffer), 0,
...
void StreamReader__Peek_fn(StreamReader* __this, int32_t* __retval)
{
    ...
    if (__this->_stream == NULL)
        U_THROW(::g::Uno::ObjectDisposedException::New4(::STRINGS[42/*"StreamReader"*/]));
...
void StreamReader__Read1_fn(StreamReader* __this, uArray* buffer, int32_t* index, int32_t* count, int32_t* __retval)
{
    ...
    if (index_ < 0)
        U_THROW(::g::Uno::ArgumentOutOfRangeException::New6(::STRINGS[43/*"index"*/]));

    if (count_ < 0)
        U_THROW(::g::Uno::ArgumentOutOfRangeException::New6(::STRINGS[44/*"count"*/]));

    if ((index_ + count_) > uPtr(buffer)->Length())
        U_THROW(::g::Uno::ArgumentException::New4(::STRINGS[45/*"range"*/]));
...
void StreamReader::ctor_1(::g::Uno::IO::Stream* stream)
{
    ...
    _byteLen = 0;
    _charBuffer = uArray::New(::TYPES[6/*char[]*/], 256);
    _charPos = 0;
    _charLen = 0;
}
...
uString* StreamReader::ReadToEnd()
{
    ...
    while (_charLen != 0)
    {
        ...
        uArray* array = uArray::New(::TYPES[6/*char[]*/], count);
...
void StreamWriter__Write1_fn(StreamWriter* __this, char16_t* value)
{
    ...
    __this->Write13(::g::Uno::Text::Utf8::GetBytes(::g::Uno::Char::ToString(value_, ::TYPES[3/*char*/])), 0, 1);
}
...
{
    ::STRINGS[46] = uString::Const("StringReader");
    ::STRINGS[39] = uString::Const("buffer");
    ::STRINGS[43] = uString::Const("index");
    ::STRINGS[44] = uString::Const("count");
    ::STRINGS[45] = uString::Const("range");
...
void StringReader__Peek_fn(StringReader* __this, int32_t* __retval)
{
    ...
    if (::g::Uno::String::op_Equality(__this->_string, NULL))
        U_THROW(::g::Uno::ObjectDisposedException::New4(::STRINGS[46/*"StringReader"*/]));
...
{
    ::STRINGS[47] = uString::Const("StringWriter");
    ::STRINGS[39] = uString::Const("buffer");
    ::STRINGS[43] = uString::Const("index");
    ::STRINGS[44] = uString::Const("count");
    ::STRINGS[45] = uString::Const("range");
    ::TYPES[6] = ::g::Uno::Char_typeof()->Array();
    ::TYPES[12] = ::g::Uno::Array_typeof()->MakeMethod(0/*Copy<char>*/, ::g::Uno::Char_typeof(), NULL);
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(::g::Uno::IO::TextWriter_type, interface0));
    type->SetFields(1,
        ::g::Uno::Bool_typeof(), offsetof(StringWriter, _open), 0,
        ::g::Uno::Text::StringBuilder_typeof(), offsetof(StringWriter, _stringBuilder), 0,
        ::TYPES[6/*char[]*/], offsetof(StringWriter, _buffer), 0,
...
void StringWriter__Write1_fn(StringWriter* __this, char16_t* value)
{
    ...
    if (!__this->_open)
        U_THROW(::g::Uno::ObjectDisposedException::New4(::STRINGS[47/*"StringWriter"*/]));
...
void StringWriter__Write3_fn(StringWriter* __this, uArray* buffer, int32_t* index, int32_t* count)
{
    ...
    if (count_ >= 256)
    {
        uArray* array = uArray::New(::TYPES[6/*char[]*/], count_);
        ::g::Uno::Array::Copy(::TYPES[12/*Uno.Array.Copy<char>*/], buffer, index_, array, 0, count_);
        uPtr(__this->_stringBuilder)->Append1(array);
    }
    else
    {
        ::g::Uno::Array::Copy(::TYPES[12/*Uno.Array.Copy<char>*/], buffer, index_, __this->_buffer, __this->_index, count_);
...
void StringWriter::ctor_1()
{
    ...
    _open = true;
    _buffer = uArray::New(::TYPES[6/*char[]*/], 256);
    _index = 0;
}
...
void StringWriter::WriteBuffer()
{
    ...
    uArray* array = uArray::New(::TYPES[6/*char[]*/], _index);
    ::g::Uno::Array::Copy(::TYPES[12/*Uno.Array.Copy<char>*/], _buffer, 0, array, 0, _index);
...
static void TextReader_build(uType* type)
{
    ...
    ::STRINGS[44] = uString::Const("count");
    ::STRINGS[45] = uString::Const("range");
    ::TYPES[13] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Char_typeof(), NULL);
    type->SetInterfaces(
...
uString* TextReader::ReadLine()
{
    ...
    ::g::Uno::Collections::List* buffer = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New2(::TYPES[13/*Uno.Collections.List<char>*/], 16);
    int32_t symbol = 0;
...
static void TextWriter_build(uType* type)
{
    ...
    ::TYPES[19] = ::g::Uno::UInt_typeof();
    ::TYPES[20] = ::g::Uno::ULong_typeof();
    type->SetInterfaces(
    ...
    type->Reflection.SetFunctions(32,
        ...
        new uFunction("Write", NULL, (void*)TextWriter__Write_fn, 0, false, uVoid_typeof(), 1, ::TYPES[14/*bool*/]),
        ...
        new uFunction("Write", NULL, NULL, offsetof(TextWriter_type, fp_Write3), false, uVoid_typeof(), 3, ::g::Uno::Char_typeof()->Array(), ::TYPES[17/*int*/], ::TYPES[17/*int*/]),
        new uFunction("Write", NULL, (void*)TextWriter__Write4_fn, 0, false, uVoid_typeof(), 1, ::TYPES[15/*double*/]),
        new uFunction("Write", NULL, (void*)TextWriter__Write5_fn, 0, false, uVoid_typeof(), 1, ::TYPES[16/*float*/]),
        new uFunction("Write", NULL, (void*)TextWriter__Write6_fn, 0, false, uVoid_typeof(), 1, ::TYPES[17/*int*/]),
        new uFunction("Write", NULL, (void*)TextWriter__Write7_fn, 0, false, uVoid_typeof(), 1, ::TYPES[18/*long*/]),
        ...
        new uFunction("Write", NULL, (void*)TextWriter__Write11_fn, 0, false, uVoid_typeof(), 1, ::TYPES[19/*uint*/]),
        new uFunction("Write", NULL, (void*)TextWriter__Write12_fn, 0, false, uVoid_typeof(), 1, ::TYPES[20/*ulong*/]),
        new uFunction("WriteLine", NULL, (void*)TextWriter__WriteLine_fn, 0, false, uVoid_typeof(), 0),
        new uFunction("WriteLine", NULL, (void*)TextWriter__WriteLine1_fn, 0, false, uVoid_typeof(), 1, ::TYPES[14/*bool*/]),
        ...
        new uFunction("WriteLine", NULL, (void*)TextWriter__WriteLine4_fn, 0, false, uVoid_typeof(), 3, ::g::Uno::Char_typeof()->Array(), ::TYPES[17/*int*/], ::TYPES[17/*int*/]),
        new uFunction("WriteLine", NULL, (void*)TextWriter__WriteLine5_fn, 0, false, uVoid_typeof(), 1, ::TYPES[15/*double*/]),
        new uFunction("WriteLine", NULL, (void*)TextWriter__WriteLine6_fn, 0, false, uVoid_typeof(), 1, ::TYPES[16/*float*/]),
        new uFunction("WriteLine", NULL, (void*)TextWriter__WriteLine7_fn, 0, false, uVoid_typeof(), 1, ::TYPES[17/*int*/]),
        new uFunction("WriteLine", NULL, (void*)TextWriter__WriteLine8_fn, 0, false, uVoid_typeof(), 1, ::TYPES[18/*long*/]),
        ...
        new uFunction("WriteLine", NULL, (void*)TextWriter__WriteLine12_fn, 0, false, uVoid_typeof(), 1, ::TYPES[19/*uint*/]),
        new uFunction("WriteLine", NULL, (void*)TextWriter__WriteLine13_fn, 0, false, uVoid_typeof(), 1, ::TYPES[20/*ulong*/]));
}
...
void TextWriter::Write(bool value)
{
    ...
    bool value_ = value;
    Write9(::g::Uno::Bool::ToString(value_, ::TYPES[14/*bool*/]));
}
...
void TextWriter::Write4(double value)
{
    ...
    double value_ = value;
    Write9(::g::Uno::Double::ToString(value_, ::TYPES[15/*double*/]));
}
...
void TextWriter::Write5(float value)
{
    ...
    float value_ = value;
    Write9(::g::Uno::Float::ToString(value_, ::TYPES[16/*float*/]));
}
...
void TextWriter::Write6(int32_t value)
{
    ...
    Write9(::g::Uno::Int::ToString(value_, ::TYPES[17/*int*/]));
}
...
void TextWriter::Write7(int64_t value)
{
    ...
    int64_t value_ = value;
    Write9(::g::Uno::Long::ToString(value_, ::TYPES[18/*long*/]));
}
...
void TextWriter::Write11(uint32_t value)
{
    ...
    Write9(::g::Uno::UInt::ToString(value_, ::TYPES[19/*uint*/]));
}
...
void TextWriter::Write12(uint64_t value)
{
    ...
    Write9(::g::Uno::ULong::ToString(value_, ::TYPES[20/*ulong*/]));
}
