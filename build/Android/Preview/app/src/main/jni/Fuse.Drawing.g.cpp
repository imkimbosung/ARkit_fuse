...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.9.0/Android/Surface.uno
// ----------------------------------------------------------------------------
...
static void AndroidSurface_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.9.0/Android/Surface.uno");
...
static void Brush_build(uType* type)
{
    ...
    ::STRINGS[12] = uString::Const("/usr/local/share/uno/Packages/Fuse.Drawing/1.9.0/Brush.uno");
    ::STRINGS[7] = uString::Const("Prepare");
    type->SetFields(2,
...
{
    DrawObjectWatcher::ShadingName_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[28/*"Shading"*/]);
}
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.9.0/Android/GraphicsSurface.uno
// ------------------------------------------------------------------------------------
...
static void LineParser_build(uType* type)
{
    ...
    ::STRINGS[24] = uString::Const("/usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.9.0/LineParser.uno");
...
void LineParser::ParseSVGPath(uString* data, uObject* segments)
{
    ...
    catch (const uThrowable& __t)
    {
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[23/*"Unsupported...*/], data, ::STRINGS[24/*"/usr/local/...*/], 19, ::STRINGS[25/*"ParseSVGPath"*/], NULL);
    }
}
// }
...
// /usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.9.0/Android/NativeSurface.uno
// ----------------------------------------------------------------------------------
...
{
    Stroke::_shadingName_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[28/*"Shading"*/]);
    Stroke::_brushName_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[29/*"Brush"*/]);
    Stroke::_colorName_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[15/*"Color"*/]);
    Stroke::_widthName_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[30/*"Width"*/]);
    Stroke::_offsetName_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[14/*"Offset"*/]);
    Stroke::_adjustmentName_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[31/*"Adjustment"*/]);
    Stroke::_alignmentName_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[32/*"Alignment"*/]);
    Stroke::_lineCapName_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[33/*"LineCap"*/]);
    Stroke::_lineJoinName_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[34/*"LineJoin"*/]);
    Stroke::_lineJoinMiterLimitName_ = ::g::Uno::UX::Selector__op_Implicit1(::STRINGS[35/*"LineJoinMit...*/]);
}
...
static void Surface_build(uType* type)
{
    ...
    ::STRINGS[37] = uString::Const("/usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.9.0/Surface.uno");
...
void Surface::Draw(::g::Fuse::DrawContext* dc, ::g::Fuse::Elements::Element* elm, uObject* drawable)
{
    ...
    if (elm != drawable)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[36/*"GLDraw call...*/], this, ::STRINGS[37/*"/usr/local/...*/], 119, ::STRINGS[38/*"Draw"*/]);
...
{
    ::STRINGS[39] = uString::Const("Path data must start with a move 'M' or 'm' operation: ");
    ::STRINGS[24] = uString::Const("/usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.9.0/LineParser.uno");
    ::STRINGS[40] = uString::Const("Execute");
    type->SetDependencies(
        ::g::Uno::Math_typeof());
    type->SetFields(0,
...
void SVGPathParser::Execute(char16_t c, char16_t prev)
{
    ...
    if ((!_hasCurrentPoint && (c != 'm')) && (c != 'M'))
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[39/*"Path data m...*/], _data), this, ::STRINGS[24/*"/usr/local/...*/], 133, ::STRINGS[40/*"Execute"*/], NULL);
