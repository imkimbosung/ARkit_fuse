...
static void Socket_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(13,
        ...
        new uFunction("Connect", NULL, (void*)Socket__Connect_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::String_typeof(), ::g::Uno::Int_typeof()),
        ...
        new uFunction("Send", NULL, (void*)Socket__Send_fn, 0, false, ::g::Uno::Int_typeof(), 1, ::g::Uno::Byte_typeof()->Array()),
...
// private extern Socket(Uno.Net.Sockets.Socket.SocketHandle handle, bool connected) :307
void Socket__ctor_1_fn(Socket* __this, int* handle, bool* connected)
{
    __this->ctor_1(*handle, *connected);
}

// public Uno.Net.Sockets.Socket Accept() :518
void Socket__Accept_fn(Socket* __this, Socket** __retval)
{
    *__retval = __this->Accept();
}

// public void Bind(Uno.Net.EndPoint endPoint) :453
...
// public void Connect(string address, int port) :408
void Socket__Connect_fn(Socket* __this, uString* address, int32_t* port)
{
    __this->Connect(address, *port);
}
...
// public void Listen(int backlog) :478
...
// private extern Socket New(Uno.Net.Sockets.Socket.SocketHandle handle, bool connected) :307
...
// public int Send(byte[] buffer) :427
void Socket__Send_fn(Socket* __this, uArray* buffer, int32_t* __retval)
{
    *__retval = __this->Send(buffer);
}
...
// private extern Socket(Uno.Net.Sockets.Socket.SocketHandle handle, bool connected) [instance] :307
...
void Socket::Bind(::g::Uno::Net::EndPoint* endPoint)
{
    ...
    if (ipEndPoint != NULL)
    {
        int32_t result = ::g::Uno::Net::Sockets::SocketHelpers::Bind(_handle, ::g::Uno::Net::Sockets::SocketHelpers::GetFamily(uPtr(ipEndPoint)->AddressFamily()), uPtr(uPtr(ipEndPoint)->Address())->GetAddressBytes(), uPtr(uPtr(ipEndPoint)->Address())->ScopeId(), uPtr(ipEndPoint)->Port());
...
// public void Connect(string address, int port) [instance] :408
void Socket::Connect(uString* address, int32_t port)
{
    uStackFrame __("Uno.Net.Sockets.Socket", "Connect(string,int)");
    ::g::Uno::Net::IPEndPoint* endPoint = ::g::Uno::Net::IPEndPoint::New1(::g::Uno::Net::IPAddress::Parse(address), port);
    Connect1(endPoint);
}
...
// public int Send(byte[] buffer) [instance] :427
int32_t Socket::Send(uArray* buffer)
{
    uStackFrame __("Uno.Net.Sockets.Socket", "Send(byte[])");
    return Send1(buffer, 0, uPtr(buffer)->Length(), 0);
}
...
// private extern Socket New(Uno.Net.Sockets.Socket.SocketHandle handle, bool connected) [static] :307
...
// public static Uno.Net.Sockets.Socket.SocketHandle Accept(Uno.Net.Sockets.Socket.SocketHandle sock) :218
void SocketHelpers__Accept_fn(int* sock, int* __retval)
{
    *__retval = SocketHelpers::Accept(*sock);
}

// public static int Bind(Uno.Net.Sockets.Socket.SocketHandle sock, int family, byte[] address, long scopeId, int port) :173
...
// public static Uno.Net.Sockets.Socket.SocketHandle Accept(Uno.Net.Sockets.Socket.SocketHandle sock) [static] :218
int SocketHelpers::Accept(int sock)
{
    return accept(sock, NULL, NULL);
}

// public static int Bind(Uno.Net.Sockets.Socket.SocketHandle sock, int family, byte[] address, long scopeId, int port) [static] :173
int32_t SocketHelpers::Bind(int sock, int32_t family, uArray* address, int64_t scopeId, int32_t port)
{
