...
#include <Outracks.Simulator.Cl-33feea6f.h>
...
#include <Outracks.Simulator.Cl-6c9c43c.h>
...
#include <Outracks.Simulator.Cl-804a3b28.h>
#include <Outracks.Simulator.Cl-836a59ac.h>
#include <Outracks.Simulator.Cl-90f523fb.h>
#include <Outracks.Simulator.Cl-9122e8a8.h>
...
#include <Outracks.Simulator.Cl-ee80a878.h>
#include <Outracks.Simulator.Cl-f2c14998.h>
#include <Outracks.Simulator.Cl-f37d8846.h>
#include <Outracks.Simulator.Cl-fa0825ed.h>
...
#include <Outracks.Simulator.Fo-237a9d39.h>
...
#include <Outracks.Simulator.Ru-85efa55.h>
#include <Outracks.Simulator.Ru-89c0ca37.h>
#include <Outracks.Simulator.Ru-ccaa6d51.h>
#include <Outracks.Simulator.Ru-ee31b8ed.h>
...
{
    {
        ...
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetGUID415", "()Ljava/lang/String;");
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetName416", "()Ljava/lang/String;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        uString* __result = JniHelper::JavaToUnoString((jstring)__jresult);
        if (__jresult!=NULL && U_JNIVAR->GetObjectRefType(__jresult) == JNILocalRefType) U_JNIVAR->DeleteLocalRef(__jresult);
        ::g::Android::Base::JNI::CheckException();
