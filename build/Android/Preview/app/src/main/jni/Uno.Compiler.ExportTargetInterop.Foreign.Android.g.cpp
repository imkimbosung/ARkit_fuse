...
jobject JNICALL callUno_Neovisionaries_WebSocketClient__webSocketGet409(JNIEnv *env,jclass clazz,jobject jthis)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Action_double_double(JNIEnv *env,jclass clazz,jobject theDelegate,jdouble arg1,jdouble arg2)
{
    uAutoReleasePool pool;
    INIT_JNI;
    uDelegate* uno_theDelegate = uCast<uDelegate*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(theDelegate), ::g::Uno::Action2_typeof()->MakeType(::g::Uno::Double_typeof(), ::g::Uno::Double_typeof(), NULL));
    double uno_arg1 = (double)arg1;
    double uno_arg2 = (double)arg2;
    JTRY
        uno_theDelegate->Invoke(2, uCRef(uno_arg1), uCRef(uno_arg2));
    JCATCH
}
...
void JNICALL callUno_Action_int_float_float(JNIEnv *env,jclass clazz,jobject theDelegate,jint arg1,jfloat arg2,jfloat arg3)
{
    uAutoReleasePool pool;
    INIT_JNI;
    uDelegate* uno_theDelegate = uCast<uDelegate*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(theDelegate), ::g::Uno::Action3_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Uno::Float_typeof(), ::g::Uno::Float_typeof(), NULL));
    int32_t uno_arg1 = (int32_t)arg1;
    float uno_arg2 = (float)arg2;
    float uno_arg3 = (float)arg3;
    JTRY
        uno_theDelegate->Invoke(3, uCRef<int32_t>(uno_arg1), uCRef(uno_arg2), uCRef(uno_arg3));
    JCATCH
}
...
void JNICALL callUno_Neovisionaries_WebSocketClient__webSocketSet409(JNIEnv *env,jclass clazz,jobject jthis,jobject setVal,jlong setValPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Neovisionaries::WebSocketClient* uno_jthis = uCast<::g::Neovisionaries::WebSocketClient*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Neovisionaries::WebSocketClient_typeof());
...
void ExternBlockHost::RegisterFunctions()
{
    ...
    {(char* const)"callUno_Action_double_double", (char* const)"(Lcom/foreign/Uno/Action_double_double;DD)V", (void *)&callUno_Action_double_double},
    ...
    {(char* const)"callUno_Action_int_float_float", (char* const)"(Lcom/foreign/Uno/Action_int_float_float;IFF)V", (void *)&callUno_Action_int_float_float},
    {(char* const)"callUno_Neovisionaries_WebSocketClient__webSocketGet409", (char* const)"(Lcom/uno/UnoObject;)Ljava/lang/Object;", (void *)&callUno_Neovisionaries_WebSocketClient__webSocketGet409},
    ...
    {(char* const)"callUno_Neovisionaries_WebSocketClient__webSocketSet409", (char* const)"(Lcom/uno/UnoObject;Ljava/lang/Object;J)V", (void *)&callUno_Neovisionaries_WebSocketClient__webSocketSet409},
    };
    int funcCount = 128;
