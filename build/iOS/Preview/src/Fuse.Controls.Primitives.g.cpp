...
// public float get_ShadowSize() [instance] :55
float ShadowElement::ShadowSize()
{
    return _size;
}

// public void set_ShadowSize(float value) [instance] :56
