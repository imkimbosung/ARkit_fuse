...
static void sensorButton_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("Pages/RespberryPi.ux");
    ::STRINGS[2] = uString::Const("Text");
    ::TYPES[0] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL);
    ::TYPES[1] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    type->SetDependencies(
        ::g::AR_example_accessor_sensorButton_Text_typeof());
    type->SetInterfaces(
    ...
    type->SetFields(120,
        ::g::Uno::String_typeof(), offsetof(sensorButton, _field_Text), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(sensorButton, temp_Value_inst), 0,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&sensorButton::__selector0_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(4,
        new uFunction(".ctor", NULL, (void*)sensorButton__New4_fn, 0, true, type, 0),
        new uFunction("SetText", NULL, (void*)sensorButton__SetText_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::String_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("get_Text", NULL, (void*)sensorButton__get_Text_fn, 0, false, ::g::Uno::String_typeof(), 0),
        new uFunction("set_Text", NULL, (void*)sensorButton__set_Text_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::String_typeof()));
}
...
::g::Fuse::Controls::Panel_type* sensorButton_typeof()
{
    ...
    options.ObjectSize = sizeof(sensorButton);
    options.TypeSize = sizeof(::g::Fuse::Controls::Panel_type);
    type = (::g::Fuse::Controls::Panel_type*)uClassType::New("sensorButton", options);
    type->fp_build_ = sensorButton_build;
    type->fp_ctor_ = (void*)sensorButton__New4_fn;
    type->fp_cctor_ = sensorButton__cctor_4_fn;
...
// public sensorButton New() :24
void sensorButton__New4_fn(sensorButton** __retval)
{
    *__retval = sensorButton::New4();
}
...
::g::Uno::UX::Selector sensorButton::__selector0_;

// public sensorButton() [instance] :24
void sensorButton::ctor_7()
{
    uStackFrame __("sensorButton", ".ctor()");
    ctor_6();
    InitializeUX();
}

// private void InitializeUX() [instance] :28
void sensorButton::InitializeUX()
{
    uStackFrame __("sensorButton", "InitializeUX()");
    ::g::Fuse::Reactive::Constant* temp1 = ::g::Fuse::Reactive::Constant::New1(this);
    ::g::Fuse::Controls::Text* temp = ::g::Fuse::Controls::Text::New3();
    temp_Value_inst = ::g::AR_example_FuseControlsTextControl_Value_Property::New1(temp, sensorButton::__selector0_);
    ::g::Fuse::Reactive::Property* temp2 = ::g::Fuse::Reactive::Property::New1(temp1, ::g::AR_example_accessor_sensorButton_Text::Singleton());
...
void sensorButton::SetText(uString* value, uObject* origin)
{
    uStackFrame __("sensorButton", "SetText(string,Uno.UX.IPropertyListener)");
...
uString* sensorButton::Text()
{
    return _field_Text;
}

// public void set_Text(string value) [instance] :9
void sensorButton::Text(uString* value)
{
    uStackFrame __("sensorButton", "set_Text(string)");
    SetText(value, NULL);
}

// public sensorButton New() [static] :24
sensorButton* sensorButton::New4()
{
    sensorButton* obj1 = (sensorButton*)uNew(sensorButton_typeof());
    obj1->ctor_7();
    return obj1;
}
// }
