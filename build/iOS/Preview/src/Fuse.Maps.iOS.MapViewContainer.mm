...
static void MapViewContainer_build(uType* type)
{
    ...
    type->SetFields(0,
        ::TYPES[0/*Uno.Action*/], offsetof(MapViewContainer, OnReady), 0,
        ::TYPES[0/*Uno.Action*/], offsetof(MapViewContainer, OnResize), 0,
        ::g::Fuse::Maps::iOS::FuseMapView_typeof(), offsetof(MapViewContainer, Map), 0,
        ::g::ObjC::Object_typeof(), offsetof(MapViewContainer, Handle), 0);
}
...
// public MapViewContainer(Fuse.Maps.iOS.FuseMapView map) :106
void MapViewContainer__ctor__fn(MapViewContainer* __this, ::g::Fuse::Maps::iOS::FuseMapView* map)
{
    __this->ctor_(map);
}

// private ObjC.Object Create(ObjC.Object view, Uno.Action onReady, Uno.Action onResize) :113
...
// private ObjC.Object Create(ObjC.Object view, Uno.Action onReady, Uno.Action onResize) [instance] :113
...
// public ObjC.Object GetView() [instance] :131
...
// private void viewDidAppear() [instance] :118
...
// private void viewDidResize() [instance] :124
...
// public MapViewContainer New(Fuse.Maps.iOS.FuseMapView map) [static] :106
