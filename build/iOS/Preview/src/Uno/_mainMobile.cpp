...
namespace g{namespace Fuse{namespace Maps{namespace iOS{uType* FuseMapView_typeof();}}}}
namespace g{namespace Fuse{namespace Maps{namespace iOS{struct MapView_type; MapView_type* MapView_typeof();}}}}
namespace g{namespace Fuse{namespace Maps{namespace iOS{uType* MapViewContainer_typeof();}}}}
namespace g{namespace Fuse{namespace AR{namespace iOS{struct ARView_type; ARView_type* ARView_typeof();}}}}
namespace g{namespace Fuse{namespace AR{namespace iOS{uType* ARViewContainer_typeof();}}}}
namespace g{namespace Fuse{namespace AR{namespace iOS{uType* FuseARView_typeof();}}}}
...
void uInitRtti()
{
    static uType*(*factories[])() =
    {
        ...
        (uType*(*)())&::g::Fuse::Maps::iOS::FuseMapView_typeof,
        (uType*(*)())&::g::Fuse::Maps::iOS::MapView_typeof,
        (uType*(*)())&::g::Fuse::Maps::iOS::MapViewContainer_typeof,
        (uType*(*)())&::g::Fuse::AR::iOS::ARView_typeof,
        (uType*(*)())&::g::Fuse::AR::iOS::ARViewContainer_typeof,
        (uType*(*)())&::g::Fuse::AR::iOS::FuseARView_typeof,
