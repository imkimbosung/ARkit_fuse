...
public partial class MainView: Fuse.App
{
    ...
    public partial class Template: Uno.UX.Template
    {
        ...
        public Template(MainView parent, MainView parentInstance): base("ScreenPage", false)
        {
            __parent = parent;
        ...
        {
            var __self = new global::ScreenPage(__parent.router);
        ...
        static global::Uno.UX.Selector __selector0 = "ScreenPage";
    }
    [Uno.Compiler.UxGenerated]
    public partial class Template1: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template1(MainView parent, MainView parentInstance): base("HomePage", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        static global::Uno.UX.Selector __selector0 = "HomePage";
    }
    [Uno.Compiler.UxGenerated]
    public partial class Template2: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template2(MainView parent, MainView parentInstance): base("CounterPage", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        public override object New()
        {
            var __self = new global::CounterPage(__parent.router);
            __self.Name = __selector0;
            __self.SourceLineNumber = 6;
            __self.SourceFileName = "MainView.ux";
            return __self;
        }
        static global::Uno.UX.Selector __selector0 = "CounterPage";
    }
    [Uno.Compiler.UxGenerated]
    public partial class Template3: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template3(MainView parent, MainView parentInstance): base("ARscreen", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        public override object New()
        {
            var __self = new global::ARscreen(__parent.router);
            __self.Name = __selector0;
    ...
    public partial class Template4: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template4(MainView parent, MainView parentInstance): base("RespberryPi", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        public override object New()
        {
            var __self = new global::RespberryPi(__parent.router);
            __self.Name = __selector0;
            __self.SourceLineNumber = 8;
            __self.SourceFileName = "MainView.ux";
            return __self;
        }
        static global::Uno.UX.Selector __selector0 = "RespberryPi";
    }
    ...
    internal global::MySocket MySocket;
    static MainView()
    {
    ...
    void InitializeUX()
    {
        ...
        MySocket = new global::MySocket();
        router = new global::Fuse.Navigation.Router();
        var temp = new global::Fuse.Controls.Navigator();
        var ScreenPage = new Template(this, this);
        var HomePage = new Template1(this, this);
        var CounterPage = new Template2(this, this);
        var ARscreen = new Template3(this, this);
        var RespberryPi = new Template4(this, this);
        router.Name = __selector0;
        router.SourceLineNumber = 2;
        router.SourceFileName = "MainView.ux";
        temp.DefaultPath = "ScreenPage";
        temp.SourceLineNumber = 3;
        temp.SourceFileName = "MainView.ux";
        temp.Templates.Add(ScreenPage);
        temp.Templates.Add(HomePage);
        temp.Templates.Add(CounterPage);
        temp.Templates.Add(ARscreen);
        temp.Templates.Add(RespberryPi);
