...
namespace g{struct AR_example_accessor_sensorButton_Text;}
...
struct AR_example_accessor_sensorButton_Text : ::g::Uno::UX::PropertyAccessor
{
    static uSStrong< ::g::Uno::UX::PropertyAccessor*> Singleton_;
    static uSStrong< ::g::Uno::UX::PropertyAccessor*>& Singleton() { return AR_example_accessor_sensorButton_Text_typeof()->Init(), Singleton_; }
    static ::g::Uno::UX::Selector _name_;
    static ::g::Uno::UX::Selector& _name() { return AR_example_accessor_sensorButton_Text_typeof()->Init(), _name_; }

    void ctor_1();
    static AR_example_accessor_sensorButton_Text* New1();
};
// }
