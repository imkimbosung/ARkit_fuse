...
struct MapView : ::g::Fuse::Controls::Native::iOS::LeafView
{
    ...
    int32_t AddMarker(int32_t uid, uString* label, double lat, double lng, uString* iconPath, float iconAnchorX, float iconAnchorY);
    bool AllowRotate();
    ...
    void OnMapTouch(int32_t type, double lat, double lng);
    uDelegate* OnReady();
